...
export const metadata: Metadata = {
  title: 'Changelog — HSC Data',
  description: 'Recent updates and fixes to HSC Data.',
};
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="mt-1 text-sm text-muted">Recent updates and fixes to HSC Data.</p>
        ...
        <p className="mt-12 text-xs text-muted/50">More updates coming.</p>
      </div>
    </div>
  );
}
